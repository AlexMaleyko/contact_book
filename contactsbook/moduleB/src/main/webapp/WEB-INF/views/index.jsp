...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/stylesheets/indexStylesheet.css" >
...
<section>
    <div>
        <button type="submit" id="createContact" value="createContact" form="contactForm" formmethod="post" formaction="contacts/new">
            Создать
        </button>
    ...
    <form method="post" id="contactForm" action="CreateContactForm">
        <table id="contactTable">
            ...
            <c:forEach items="${contacts}" var="contact">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/app/contacts/${contact.contactId}"><span>${contact.surname} ${contact.name} ${contact.patronymic}</span></a></td>
                    <td>${contact.birth}</td>
    ...
    <form id="backToListForm" method="get" action="contacts">
    </form>

    <div id="pagination"></div>
    <form id="paginationForm" method="post" action="${paginationFormAction}">
