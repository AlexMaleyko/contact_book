...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/stylesheets/contactForm.css" >
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/stylesheets/modal.css" >
    <script src="${pageContext.request.contextPath}/resources/js/contactForm.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/modal.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/validation.js"></script>
    <script src="${pageContext.request.contextPath}/resources/js/profileIMGmodal.js"></script>
    <meta charset="UTF-8">
</head>
<body>
<div id="pgBtns">
<button  type="submit" id="saveAll" form="contactForm">Сохранить все</button>
<button type="submit" form="contactList" formaction="${pageContext.request.contextPath}/app/contacts" id="cancelAll" formmethod="post">Отменить изменения</button>
</div>
<section id="container">
    <form id="contactForm" method="post" enctype="multipart/form-data" onsubmit="contactFormValidator();return false" action="${pageContext.request.contextPath}/app/${formaction}">
    <section id="contact">
        <div id="profileImgContainer">
            <img id="profileImg" alt="profileImg" src="${pageContext.request.contextPath}/app/image?contactId=${contact.contactId}"/>
        </div>
            ...
            <table id="attachTable">
                ...
                <c:forEach items="${contact.attachmentDTOList}" var="attach">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/app/attachment?attachmentId=${attach.attachmentId}" target="_blank"><span>${attach.fileName}</span></a>
